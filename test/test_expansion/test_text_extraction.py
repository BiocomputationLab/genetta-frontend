...
from app.tools.enhancer.enhancements.interaction.text_extraction import TruthTextExtraction
from app.tools.enhancer.enhancements.interaction.text_extraction import DesignTextExtraction
