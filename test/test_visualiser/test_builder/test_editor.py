...
class TestEditor(unittest.TestCase):
    ...
    def test_add_edges_full(self):
        ...
        self.wg.driver.remove_edge(res[0].n,res[0].v,res[0].get_type())
        self.wg.driver.submit()
        res = self.dg.edges(node1,node2,e)
        self.assertTrue(len(res)==0)

    def test_add_edges_pruned(self):
        from app.tools.visualiser.builder.builders.design.pruned import bl_pred
    ...
    def test_add_edges_interaction_advanced(self):
        ...
        self.builder.set_design(dg,"ALL")
