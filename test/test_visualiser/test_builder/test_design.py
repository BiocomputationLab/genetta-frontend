...
class TestViews(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.builder.set_design(self.dg,"ALL")
    ...
    def test_views_multiple_graphs_any(self):
        ...
        fn1 = os.path.join(curr_dir,"..","..","files","0xC7.xml")
        fn2 = os.path.join(curr_dir,"..","..","files","0x87.xml")
        fn3 = os.path.join(curr_dir,"..","..","files","0x3B.xml")
        ...
        self.builder.set_design(dg2,"ANY")
        self.builder.set_interaction_view()
        self.builder.build()
        ...
        self.builder.set_design(dg3,"ANY")
        self.builder.set_interaction_view()
        self.builder.build()
        graph3 = self.builder.view
        edges3 = list(graph3.edges())

        adg = self.wg.get_design([gn1,gn2,gn3])
        self.builder.set_design(adg,"ANY")
        self.builder.set_interaction_view()
        self.builder.build()
        graph = self.builder.view
