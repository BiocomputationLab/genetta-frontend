...
from app.tools.data_miner.ontology.server_interface.utility.identifiers import Identifiers
from app.tools.data_miner.ontology.server_interface.utility.static_data import StaticOntologyData
