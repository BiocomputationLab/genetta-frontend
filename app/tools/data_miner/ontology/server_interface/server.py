...
from app.tools.data_miner.ontology.server_interface.utility.query_builder import QueryBuilder
from app.tools.data_miner.ontology.server_interface.utility.ontology_graph import OntologyGraph
