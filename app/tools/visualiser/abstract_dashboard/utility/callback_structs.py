...
procedure_i = []
procedure_s = []
procedure_o = {"table" :  Output("procedure_table", "children")}
...
select_node_s = {"elements": State(graph_id, 'elements'),
                      "snd": State(graph_id, 'selectedNodeData'),
                      "edge_subject": State("edge_subject", "children"),
                      "edge_object": State("edge_object", "children")}
select_node_o = {"edge_subject": Output(select_node_s["edge_subject"].component_id, "children"),
                "edge_object": Output(select_node_s["edge_object"].component_id, "children"),
