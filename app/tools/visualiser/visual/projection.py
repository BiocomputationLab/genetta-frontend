...
from app.tools.visualiser.builder.projection import ProjectionBuilder
from app.tools.visualiser.visual.abstract import AbstractVisual
from app.tools.visualiser.visual.handlers.design.layout import LayoutHandler
from app.tools.visualiser.visual.handlers.design.label import LabelHandler
from app.tools.visualiser.visual.handlers.design.color import ColorHandler
from app.tools.visualiser.visual.handlers.design.size import SizeHandler
from app.tools.visualiser.visual.handlers.design.shape import ShapeHandler
...
class ProjectionVisual(AbstractVisual):
    ...
    def set_design_names(self,names):
        self._builder.set_design_names(names)
